...
- The project agent definitions enable full tracebility of the process, from
  ...
  significant degree tracebility at the issue level. -- The template based
  /requirments document continue to evolve in realtime adding the elaborated
...
- What is the impact of a much larger repo on th effectiveness of this agents
...
- Engineering team responsbility shifts. We may become known as builders. 
  ...
  responsbility) has monitor the autogenerated specs and testing scripts.
  ...
  e.g. deployment and database migration scripts. Similarly coding engineers
  still own the quality of our code base, including slop!
